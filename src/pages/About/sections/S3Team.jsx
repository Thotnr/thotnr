...
import kogielambal from '../../../assets/images/kogielambal-subramoney-2.jpg'
import sumit from '../../../assets/images/sumit-garg-2.jpg'
import sachin from '../../../assets/images/sachin-2.jpg'
import sanjay from '../../../assets/images/sanjay-gupta-2.jpg'
...
const team = [
  ...
  { id: 9, img: kogielambal,name: 'KOGIELAMBAL SUBRAMONEY',     role: 'Regional Growth Director',    desc: 'Leading Strategic Expansion' },
  { id: 10, img: sumit, name: 'SUMIT GARG',       role: 'Financial Operations Lead',       desc: 'Driving Fiscal Excellence' },
  { id: 11, img: sachin, name: 'SACHIN MITTAL',     role: 'Techy with Vision',       desc: 'Driven by Innovation' },
  { id: 12, img: sanjay, name: 'SANJAY GUPTA',     role: 'AI Architect',       desc: 'An Intelligence Strategist' },
  { id: 13,img: gauraksha, name: 'GAURAKSHA KAUTILYA',  role: 'Enterprise Solution Architect',       desc: 'A Systems Thinker' }
]
