    ...
    >
      ...
      <div className="hero-content hero-content-pos">
        ...
        <h1 style={{
          ...
          Thinking<br />
          <em style={{ fontStyle: 'italic', color: 'var(--color-accent)', opacity: 0.62 }}>Out Loud</em>
        </h1>
        ...
        <p style={{
          ...
          Perspectives on AI, enterprise technology, and the future of intelligent organisations — from the people building them.
        </p>
